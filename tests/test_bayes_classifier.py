...
def test_bc_multivariate_mixed_nan_predict_log_proba():
	y_hat = model.predict_log_proba(X_nan)
	y = [[ -7.74751377e-01,  -6.17702728e-01],
		 [ -1.17476264e+00,  -3.69459592e-01],
		 [ -3.32454353e-02,  -3.42041447e+00],
		 [ -3.04858735e+00,  -4.85873516e-02],
		 [ -1.03177542e+01,  -3.30417805e-05],
		 [ -1.71092645e-03,  -6.37157561e+00],
		 [ -3.04833765e+00,  -4.85997853e-02],
		 [ -2.61764180e-01,  -1.46833995e+00],
		 [ -5.31809106e-01,  -8.85618675e-01],
		 [ -1.19994789e+00,  -3.58404880e-01]]
...
def test_bc_multivariate_mixed_nan_predict_proba():
	y_hat = model.predict_proba(X_nan)
	y = [[  4.60818337e-01,   5.39181663e-01],
		 [  3.08892290e-01,   6.91107710e-01],
		 [  9.67301121e-01,   3.26988794e-02],
		 [  4.74258732e-02,   9.52574127e-01],
		 [  3.30412347e-05,   9.99966959e-01],
		 [  9.98290536e-01,   1.70946365e-03],
		 [  4.74377172e-02,   9.52562283e-01],
		 [  7.69692511e-01,   2.30307489e-01],
		 [  5.87541084e-01,   4.12458916e-01],
		 [  3.01209908e-01,   6.98790092e-01]]
